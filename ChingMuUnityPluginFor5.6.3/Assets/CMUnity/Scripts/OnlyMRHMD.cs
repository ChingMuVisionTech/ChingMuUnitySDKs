...
public class OnlyMRHMD : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        Pos = CMUnity.CMPosWithImu(Config.Instance.ServerIP, Config.Instance.CMTrackPreset.IMUBodies[1], pose);
        Rot = CMUnity.CMQuatWithImu(Config.Instance.ServerIP, Config.Instance.CMTrackPreset.IMUBodies[1], pose);
